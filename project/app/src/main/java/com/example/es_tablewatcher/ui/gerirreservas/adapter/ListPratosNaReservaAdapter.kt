...
class ListPratosNaReservaAdapter(context: Context, data: List<Prato>, private val onClickListener: (prato: Prato)->Unit) :
    RecyclerView.Adapter<ListPratosNaReservaAdapter.ViewHolder>() {

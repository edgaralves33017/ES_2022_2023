package com.example.es_tablewatcher.ui.gerirpratos.adapter
...
class ListPratosAdapter(context: Context, data: List<Prato>, private val isAdmin: Boolean, private val onClickListener: (prato: Prato)->Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = mInflater.inflate(R.layout.item_listprato, parent, false)
